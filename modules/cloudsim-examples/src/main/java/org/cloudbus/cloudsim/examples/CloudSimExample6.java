...
public class CloudSimExample6 {
	...
	static PolicyGUI po1 = new PolicyGUI();
static double max;
    //static LineCharts lc1=new LineCharts(null);
    static double[] m=new double[40];
	...
	private static List<Vm> createVM(int userId, int vms) {
		...
		int[] mips ={100,200,600,154,251,800,465,440,523,961,100,200,600,154,251,800,465,440,523,961};//1000p1.x1
		long bw = 1000;
	...
	//	long length = p1.x2;//1000p1.x2;
		...
		long length =LineCharts.testlength;
	...
	private static Datacenter createDatacenter(String name){
		...
		int hostId=0;
		int ram = 2048; //host memory (MB)2048
	...
	private static void printCloudletList(List<Cloudlet> list) {
		...
		try {
			...
			for (int i = 0; i < size; i++) {
				...
				//m[i]=cloudlet.getFinishTime();out.write(m);
			}
